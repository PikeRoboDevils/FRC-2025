...
public class Constants {
  ...
  public static class PoseCameraConstants {
    public static double maxVisionStdDevsDistance =
        30; // the distance at which std devs start to increase with distance
  ...
  public static class PathPlanner {
    ...
    private static final ModuleConfig modConfig =
        new ModuleConfig(2, Swerve.MAXSPEED, 1.15, DCMotor.getNEO(1), AUTO_CURRENT_LIMIT, 1);
