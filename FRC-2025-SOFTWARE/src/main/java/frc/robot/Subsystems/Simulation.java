...
public class Simulation implements Subsystem {
  ...
  public static final Simulation[] instances = new Simulation[5];
              ...
              final ChassisSpeeds fieldCentricSpeeds =
                  ChassisSpeeds.fromRobotRelativeSpeeds(
                      ...
                      FieldMirroringUtils.getCurrentAllianceDriverStationFacing()
                          .plus(Rotation2d.fromDegrees(180)));
              driveSimulation.runChassisSpeeds(
                  joystickSpeeds.get(), new Translation2d(), true, true);
  ...
  public static Pose2d[] getOpponentRobotPoses() {
    return getRobotPoses(new Simulation[] {instances[0], instances[1], instances[2]});
  }

  public static Pose2d[] getAlliancePartnerRobotPoses() {
    return getRobotPoses(new Simulation[] {instances[3], instances[4]});
  }

  private static Pose2d[] getRobotPoses(Simulation[] instances) {
