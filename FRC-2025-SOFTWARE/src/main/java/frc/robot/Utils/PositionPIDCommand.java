...
public class PositionPIDCommand extends Command {
  ...
  private PPHolonomicDriveController mDriveController = DRIVE_CONTROLLER;
  ...
  private PositionPIDCommand(Swerve mSwerve, Pose2d goalPose) {
  ...
  public static Command generateCommand(
      Swerve swerve, Pose2d goalPose, Time timeout, Boolean freeze) {
  ...
  public void end(boolean interrupted) {
    ...
    System.out.println(
        "Adjustments to alginment took: "
            ...
            + " deg"
            + "\nVelocity value: "
            + "INFINITE SPEED!!!" // mSwerve.getSpeed() + "m/s"
